...
def test_video_chat_server_startup():
    server = VideoChatServer(host='127.0.0.1', video_port=9100, audio_port=9101, text_port=9102)
    server.start()
...
def test_video_chat_client_connect():
    server = VideoChatServer(host='127.0.0.1', video_port=9103, audio_port=9104, text_port=9105)
    server.start()
    time.sleep(1)
...
def test_video_chat_rooms():
    server = VideoChatServer(host='127.0.0.1', video_port=9106, audio_port=9107, text_port=9108)
    server.start()
    time.sleep(1)
...
def test_video_chat_audio_disabled():
    ...
    server = VideoChatServer(host='127.0.0.1', video_port=9109, audio_port=9110, text_port=9111)
    server.start()
    time.sleep(1)
    ...
    try:
        ...
        assert client.audio_available == False
        assert client.running == True
...
def test_video_chat_server_cleanup():
    ...
    server = VideoChatServer(host='127.0.0.1', video_port=9112, audio_port=9113, text_port=9114)
    server.start()
    time.sleep(1)
